...
- `[BRIEF_FILE]` — REQUIRED: the task brief file (`scripts/task-brief PLAN_FILE N`
...
- `[DIFF_FILE]` — REQUIRED: the path the controller wrote with
  `scripts/review-package PLAN_FILE BASE HEAD`; this is the initial full
  task review, not the scoped re-review package.
