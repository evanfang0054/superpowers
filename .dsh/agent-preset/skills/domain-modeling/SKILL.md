...
whenToUse: "[feedforward] Triggered when domain terms need defining, sharpening, or when an architectural decision crystallizes. [feedback] Triggered when terminology conflicts are detected during other skills' work."
---
